...
function startup() {
  ...
  var ks = document.getElementById("key_sumbit");
  ...
  ks.addEventListener("click", handleClick, false);
...
function handleClick(evt) {
  ...
  if ( evt.target.id=='left_click'){
    ...
    sendSignal();
  }else if ( evt.target.id=='key_sumbit'){
  	let ki = document.getElementById("key_section");
    moveData.type = "key";
    moveData.string = ki.value;
    ki.value = "";
    sendSignal();
